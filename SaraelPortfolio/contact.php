    ...
    <div class="main">
        <div class="contact-form">
            ...
            <form action="contact.php" method="POST">
                ...
                <div class="mb-3">
                    <label for="enquiry" class="form-label">What is your Enquiry? :) </label>
...
$con=mysqli_connect("localhost","root","","srlportfolio") or die(mysqli_error());
...
$sql="INSERT INTO `clients_tbl`(`id`, `fullName`, `mobileNo`, `emailId`, `message`) VALUES (Null,'$fullName','$mobileNo','$emailId','$clientMsg')";
